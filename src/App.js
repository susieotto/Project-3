	...
	if (props.loggedIn) {
		...
		return (
			<nav className="navbar">
				<ul className="nav">
					<li className="nav-item">
						<Link to="/login" id="login-btn" className="nav-link white-text">
							login
						</Link>
					</li>
					<li className="nav-item">
						<Link to="/signup" id="signup-btn" className="nav-link white-text">
							signup
						</Link>
					</li>
					<li className="nav-item">
						<img alt="calabs" src="./assets/images/calabs_nav_80.png"></img>
					</li>
				</ul>
			</nav>
		)
...
class App extends Component {
	...
	render() {
		...
		return (
			<div className="App">
				<h3 className="brand-logo">CALABS</h3>
